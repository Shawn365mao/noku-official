...
const ServiceCard = ({ title, icon, name, description, features, accentColor, bgGradient }) => {
  const href = icon === "WeXun" ? "https://wexun.com" : icon === "YouBo" ? "https://youbo.com" : "https://promisebook.net";
  return (
            ...
            <div className="mt-10 max-w-5xl mx-auto px-4">
              ...
              <div className="mt-6 text-blueGray-700 text-xl lg:text-3xl font-medium leading-relaxed">
                <div className="flex flex-col gap-4">
                  <div>
                    <span className="text-blueGray-900 font-extrabold">WeXun</span> 与 <span className="text-blueGray-900 font-extrabold">YouBo</span>
                  ...
                  <div>
                    <span className="text-blueGray-900 font-extrabold">PromiseBook</span>
                    <span className="mx-2 text-blueGray-400">·</span>
      ...
      <section className="py-24 bg-white relative z-10">
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-4">
            ...
            <ServiceCard title="生活交易与声誉社区" icon="YouBo" name="YouBo（优博）" accentColor="#FF9500" bgGradient="linear-gradient(180deg, rgba(255,149,0,0.05) 0%, #ffffff 50%)" description={{ bold: "诚实交易，积累生活声誉。", normal: "让口碑建立在“真实发生”之上，而非“主观印象”之上。" }} features={["真实身份与交易链路", "纠纷可追溯，责任更清晰", "沉淀可复用的生活信用"]} />
            <ServiceCard title="信用账本与证明基础设施" icon="PromiseBook" name="PromiseBook（诺书）" accentColor="#B8860B" bgGradient="linear-gradient(180deg, rgba(184,134,11,0.06) 0%, #ffffff 50%)" description={{ bold: "行为变资产，守诺即价值。", normal: "不裁判、不背书，只做标准化存证、出具与核验。" }} features={["可核验的行为存证", "跨平台信用映射", "机构级授权接口"]} />
          </div>
