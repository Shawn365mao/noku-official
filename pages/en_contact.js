...
const ContactEn = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const dept = form.dept?.value || "Partnership";
    ...
    const body = [
      ...
      "",
      "----",
      "Sent from nokuinc.com contact page",
    ].join("\n");
  ...
  return (
    <>
      <Layout>
        {/* ✅ Header 已 fixed：不要再用 -mt-24 / pt-40 */}
              ...
              <div className="w-full lg:w-1/2 px-3 mb-10 lg:mb-0">
                <div className="max-w-md">
                  ...
                  <p className="text-blueGray-400 leading-relaxed mb-8">
                    Whether you are exploring protocol integration, institutional
                    collaboration, or long-term trust infrastructure alignment,
                    we welcome serious and constructive conversations.
                  </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blueGray-400">
                        Digitally Native · Borderless Collaboration
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 sm:p-8 bg-white rounded-2xl shadow-2xl border border-blueGray-100">
                  <form onSubmit={handleSubmit}>
                    ...
                    <p className="mt-4 text-xs text-blueGray-400">
                      After submission, your email client will open automatically
                      with the message pre-filled. No backend required.
                    </p>
                  </form>
                </div>
              </div>
